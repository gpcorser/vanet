...
int main(int argc, char *argv[])
{
    ...
    for (int i=0; i<zone_qty; i++) k_assign_t[i] = i*zone_time;// rev:2015-02-28
    ...
    cout << "otfp-r density1 " << radius << " " << zone_qty << setprecision(5) 
        << fixed << " " << avg_k << " " << avg_d << " " << avg_t 
        << " " << anoncount << " " << maxv << " " << avg_max_k << endl; //gpc20150829
    if (input_type == 1) // urban
        cout << "otfp-r density2 " << radius << " " << zone_qty << setprecision(5) 
        << fixed << " " << avg_k << " " << avg_d << " " << avg_t 
        << " " << anoncount << " " << maxv << " " << avg_max_k << endl; //gpc20150829
    if (input_type == 2) // city
        cout << "otfp-r density3 " << radius << " " << zone_qty << setprecision(5) 
        << fixed << " " << avg_k << " " << avg_d << " " << avg_t 
        << " " << anoncount << " " << maxv << " " << avg_max_k << endl; //gpc20150829
